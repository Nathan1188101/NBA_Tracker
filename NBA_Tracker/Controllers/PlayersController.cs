...
namespace NBA_Tracker.Controllers
{
    ...
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlayerId,FirstName,LastName,Position,TeamId")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlayerId,FirstName,LastName,Position,TeamId")] Player player)
        {
